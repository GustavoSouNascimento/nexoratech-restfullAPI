...
public class TesteAtualizar {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        int usuario = JOptionPane.showConfirmDialog(null, "Deseja atualizar informações de Usuario?", "Nexoratech", JOptionPane.YES_NO_OPTION);
        if (usuario == 0) {
            do{
                ...
                System.out.println(userDao.atualizar(objUsuario));
            } while( JOptionPane.showConfirmDialog(null, "Deseja atualizar mais informações de Usuario?", "Nexoratech", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == 0);
        }

        int voluntario = JOptionPane.showConfirmDialog(null, "Deseja atualizar informações de Voluntario?", "Informações de Voluntario", JOptionPane.YES_NO_OPTION);
        if (voluntario == 0) {
            do {
                ...
                System.out.println(volunDao.atualizar(objVoluntario));
            } while (JOptionPane.showConfirmDialog(null, "Deseja atualizar mais informações de Voluntario?", "Nexoratech", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == 0);
        }

        int paciente = JOptionPane.showConfirmDialog(null, "Deseja atualizar informações de Paciente?", "Informações de Paciente", JOptionPane.YES_NO_OPTION);
        if (paciente == 0) {
            do {
                ...
                System.out.println(paciDao.atualizar(objPaciente));
            } while (JOptionPane.showConfirmDialog(null, "Deseja atualizar mais informações para Paciente?", "Nexoratech", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == 0);
        }

        int triagem = JOptionPane.showConfirmDialog(null, "Deseja atualizar informações de Triagem?", "Informações de Triagem", JOptionPane.YES_NO_OPTION);
        if (triagem == 0) {
            do{
                ...
                System.out.println(triDao.atualizar(objTriagem));
            } while( JOptionPane.showConfirmDialog(null, "Deseja atualizar mais informações para Triagem?", "Nexoratech", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == 0);
        }

        int tratamento = JOptionPane.showConfirmDialog(null, "Deseja atualizar informações de Tratamento?", "Informações de Tratamento", JOptionPane.YES_NO_OPTION);
        if (tratamento == 0) {
            do {
                ...
                System.out.println(trataDao.atualizar(objTratamento));
            } while (JOptionPane.showConfirmDialog(null, "Deseja atualizar mais informações para Tratamento?", "Nexoratech", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == 0);
        }

        int agendamento = JOptionPane.showConfirmDialog(null, "Deseja atualizar informações de Agendamento?", "Informações de Agendamento", JOptionPane.YES_NO_OPTION);
        if (agendamento == 0) {
            do {
                ...
                System.out.println(agendaDao.atualizar(objAgendamento));
            } while (JOptionPane.showConfirmDialog(null, "Deseja atualizar mais informações para Agendamento?", "Nexoratech", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == 0);
        }
    }
}
